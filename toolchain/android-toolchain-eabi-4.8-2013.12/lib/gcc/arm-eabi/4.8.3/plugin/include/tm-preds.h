/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain-4.8.2013.12/build/objdir/../build/../gcc/gcc-linaro-4.8-2013.12/gcc/config/arm/arm.md'.  */
