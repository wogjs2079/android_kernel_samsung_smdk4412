...
#elif 1//(LINUX_VERSION_CODE >= KERNEL_VERSION(3, 3, 0)) || \
...
#if (defined(ROAM_ENABLE) || defined(BCMFW_ROAM_ENABLE)) && 1 && !defined(CUSTOMER_HW4)
...
#if 0//((LINUX_VERSION_CODE >= KERNEL_VERSION(3, 0, 0)) && (LINUX_VERSION_CODE <= \
